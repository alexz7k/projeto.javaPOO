    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            LocalTime horarioAtual = LocalTime.now();
             if (horarioAtual.isBefore(LocalTime.of(12, 0))) {
                       out.println("<h1>Bom dia!</h1>");
        } else if (horarioAtual.isBefore(LocalTime.of(18, 0))) {
                       out.println("<h1>Boa tarde!</h1>");
        } else if (horarioAtual.isBefore(LocalTime.of(22, 0))) {
                       out.println("<h1>Boa noite!</h1>");
        } else {
                     out.println("<h1>Va dormir!</h1>");
        }
